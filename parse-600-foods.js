...
const foodData = [
    ...
    // Note: This is a sample of the 600 items. The complete list would continue with all 600 items
    // as provided by the user in their table format
];
